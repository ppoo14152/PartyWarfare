...
/**
 * Muestra la interfaz grafica para escojer el escenario de MEXICO en el juego.
 * 
...
public class EscogeE1 extends World
{
     ...
     * 
     */
    public EscogeE1(int next,int prev,GreenfootSound music,Jugador jug,Enemigo ene)
    {    
