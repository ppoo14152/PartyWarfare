...
/**
 * Muestra la interfaz grafica para escojer el escenario de JAPON en el juego.
 * 
 * @author Irvin Alexis Rodriguez Estrada
 * @author Irving Gerardo Cardenaz Hernandez
 * @version 23/04/2015
 */
public class EscogeE5 extends World
{

    /**
     * Constructor para objetos de clase EscogeE5.
     * 
     ...
     * 
     */
    public EscogeE5(int next,int prev,GreenfootSound music,Jugador jug,Enemigo ene)
    {    
