import greenfoot.*;
/**
 * Muestra la interfaz grafica para escojer el escenario de FRANCIA en el juego.
 * 
...
public class EscogeE3 extends World
{
     ...
     * 
     */
     public EscogeE3(int next,int prev,GreenfootSound music,Jugador jug,Enemigo ene)
    {    
