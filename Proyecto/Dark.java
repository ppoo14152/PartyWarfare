...
/**
 * Esta clase representa los simbolos referente al bando de la oscuridad
...
public class Dark extends Symbol
{
     ...
     private GreenfootImage img1= new GreenfootImage("SimbolOsc.2.png");
     private GreenfootImage img2= new GreenfootImage("SimbolOsc.png");
    /**
     * CONSTRUCTOR
     * construye las caracteristicas iniciales de un simbolo
     * @param unaMusica musica actual del mundo
     */
    public Dark(GreenfootSound unaMusica)
    {
        world1=getWorld();
        music=unaMusica;
    }
